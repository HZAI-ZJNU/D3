        ...
        schedule=[
            dict(
                ...
                pipeline=[
                    dict(type='LoadImageFromFile'),
                    dict(
                        backend='pillow', scale=192, type='RandomResizedCrop'),
                    dict(direction='horizontal', prob=0.5, type='RandomFlip'),
                    dict(
                        hparams=dict(pad_val=[
                            104,
                        ...
                        magnitude_level=4.8999999999999995,
                        magnitude_std=0.5,
                        num_policies=2,
                        policies='timm_increasing',
                        total_level=10,
            ...
            dict(
                ...
                pipeline=[
                    dict(type='LoadImageFromFile'),
                    dict(
                        backend='pillow', scale=224, type='RandomResizedCrop'),
                    dict(direction='horizontal', prob=0.5, type='RandomFlip'),
                    dict(
                        hparams=dict(pad_val=[
                            104,
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(backend='pillow', scale=160, type='RandomResizedCrop'),
            dict(direction='horizontal', prob=0.5, type='RandomFlip'),
            dict(
                hparams=dict(pad_val=[
                    104,
...
train_pipeline_37e = [
    dict(type='LoadImageFromFile'),
    dict(backend='pillow', scale=192, type='RandomResizedCrop'),
    dict(direction='horizontal', prob=0.5, type='RandomFlip'),
    dict(
        hparams=dict(pad_val=[
            104,
...
work_dir = 'work_dirs/comparisions/d3/mobileone/s3'
